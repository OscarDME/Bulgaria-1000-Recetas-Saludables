...
const BASE_CHECKOUT_URL = "https://www.oriopay.app/p/1000-zdravoslovni-retsepti";
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            {finalCta.bundleList.map((item, i) => (
              <li key={i} className="flex items-start gap-3">
                ...
                <span
                  className={
                    i === 0
                      ? "text-[var(--color-accent-dark)] font-extrabold"
        ...
        <div className="mt-2 flex items-start gap-3 bg-[var(--color-brand-light)]/70 rounded-2xl px-4 py-3 max-w-2xl">
          <ShieldCheck className="w-6 h-6 text-[var(--color-brand-dark)] shrink-0 mt-0.5" />
          <p className="text-sm md:text-base text-[var(--color-brand-dark)] font-semibold text-left">
